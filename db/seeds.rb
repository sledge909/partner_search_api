...
tiles = Skill.create!(name: 'tiles', service: Service.last)
carpet = Skill.create!(name: 'carpet', service: Service.last)

partner = Partner.create!(name: 'Partner 1', address: '199 Upper Chorlton Rd, Manchester, M16 0BH', operating_radius: 5, rating: 6)
...
partner3 = Partner.create!(name: 'Partner 3', address: '374-376 Barlow Moor Rd, Manchester, M21 8AZ', operating_radius: 10, rating: 8)
partner3.services << service
partner3.skills << [wood, carpet, tiles]
...
partner5.skills << [wood, carpet, tiles]
